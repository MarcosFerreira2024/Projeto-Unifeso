  ...
  return (
    <div className="flex flex-col">
      ...
      <input
        ...
        {...outros}
        id={id}
        className="w-[250px]  placeholder:focus:text-white hover:bg-background placeholder:text-title px-5 botao outline-none h-[38px] border-[2px] border-subtitle focus:bg-[#2e8b85] bg-white  focus:text-[white] transition-all ease-linear text-title  font-roboto rounded-[10px] "
      />
    </div>
  );
}
