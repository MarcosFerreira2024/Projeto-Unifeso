      ...
      <div className="flex flex-col text-center gap-2">
        <div className="flex self-center">
          <Image
            ...
            height={height}
            width={width}
            className="object-fit object-bottom min-h-[81px] "
          />
        </div>
        <div className="mt-5 text-nowrap">
          <h1 className="sm:text-2xl text-xl  text-title font-roboto">
            {titulo}
          </h1>
        </div>
      </div>
